...
- **Coverage policy**: fixed tracking surface, flexible expansion depth.
  - **Core vectors**: Vectors 1-4 receive a full update every routine checkpoint.
  - **Watch vectors**: Vectors 5-6 receive a light check every routine checkpoint and may be marked "no significant change" rather than padded if no material evidence appeared.
